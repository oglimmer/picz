...
public class PublicAlbumController {
  ...
  @Operation(
      summary =
          "Returns information about an album by its secret id. These information contain all images including their secret ids.")
  @GetMapping
  public ResponseEntity<GetAlbumResponseImage> list(
