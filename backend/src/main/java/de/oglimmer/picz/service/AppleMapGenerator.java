...
public class AppleMapGenerator {
  ...
  private String url(
      ...
      double spanLatitude,
      double spanLongitude) {
    // PrivateKey privateKey = createPrivateKey(new
    // InputStreamReader(getClass().getResourceAsStream(privateKeyPath)));
    privateKey =
  ...
  private static Map<String, String> getStringStringMap(
    ...
    params.put(
        ...
        "[{\"point\":\""
            ...
            + ","
            + imageLongitude
            + "\",\"markerStyle\":\"large\",\"color\":\"ff2600\",\"glyphText\":\"X\"}]"); // markerStyle = dot, balloon, large, img
  ...
  private PrivateKey createPrivateKey(Reader reader)
      throws IOException,
